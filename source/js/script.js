...
window.onmousemove = function () {
    ...
    var dx = (screen_w / 2 - mouse_x);
    var dy = (screen_h / 2 - mouse_y);
    ...
    if (isMouseDown) {
        ...
        illustOverflow.style.width = "180px";
        illustOverflow.style.height = "180px";
